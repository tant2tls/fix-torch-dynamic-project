...
class TestCustomLowering(InductorTestCase):
    ...
    def test_upsample_nearestnd_symbolic_output_size(self):
        ...
        #
        # The ATen upsample ops decompose on CompositeImplicitAutograd, so they
        # never reach this lowering; drive it directly, as the tests above do.
        for exact in (False, True):
            ...
            with torch.library._scoped_library("test_ups_ops", "FRAGMENT") as lib:
                ...
                if HAS_GPU:
                    ...
                    lib.impl("ups2d", ref, GPU_TYPE.upper())
